...
LIBRE_BUILD_FLAGS_WITH_OPENSSL := \
...
libre: $(CONTRIB_FAT)/lib $(CONTRIB_SLIM)/lib
	...
	@make -sC $(LIBRE_PATH) CC='$(CC_ARM) $(CC_ARM_FLAGS)' \
		...
		$(LIBRE_BUILD_FLAGS_WITH_OPENSSL) $(EXTRA_AARCH64) \
	...
	@make -sC $(LIBRE_PATH) CC='$(CC_ARM) $(CC_ARM_FLAGS)' \
		...
		SYSROOT=$(ARMROOT) SYSROOT_ALT=$(ARMROOT_ALT) \
		$(LIBRE_BUILD_FLAGS_WITH_OPENSSL) $(EXTRA_ARMV7S) \
	...
	@make -sC $(LIBRE_PATH) CC='$(CC_ARM) $(CC_ARM_FLAGS)' \
		...
		SYSROOT=$(ARMROOT) SYSROOT_ALT=$(ARMROOT_ALT) \
		$(LIBRE_BUILD_FLAGS_WITH_OPENSSL) $(EXTRA_ARMV7) \
	...
	@make -sC $(LIBRE_PATH) CC='$(CC_SIM) $(CC_SIM_FLAGS)' \
		...
		SYSROOT=$(SIMROOT) SYSROOT_ALT=$(SIMROOT_ALT) \
		$(LIBRE_BUILD_FLAGS_WITH_OPENSSL) $(EXTRA_X86_64) \
...
BARESIP_BUILD_FLAGS_WITH_OPENSSL := \
	STATIC=1 OPT_SPEED=1 \
...
BARESIP_BUILD_FLAGS_AARCH64_NO_OPENSSL := \
	$(BARESIP_BUILD_FLAGS) \
	EXTRA_MODULES='g711 audiounit dtls_srtp srtp stun turn ice opus'
...
baresip: librem libre
	...
	@make -sC $(BARESIP_PATH) CC='$(CC_SIM) $(CC_SIM_FLAGS)' \
		...
		SYSROOT=$(SIMROOT) SYSROOT_ALT=$(ARMSIMROOT_ALT) \
		$(BARESIP_BUILD_FLAGS_AARCH64_NO_OPENSSL) $(EXTRA_AARCH64_SIM) \
		PREFIX= DESTDIR=$(CONTRIB_AARCH64_SIM) \
		install-static
